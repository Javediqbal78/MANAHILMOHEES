...
\033[1;94mFACEBOOK  Sam Oke
                  
\033[1;92mWHATAAPP   +2349071502233
...
print("""
        ...
        |........   Fast Facebook clone   ........|
        +-----------------------------------------+
        | #Author: MANAHIL MOHEES         | 
        |  LOVE YOU PAKISTAN                     |
        | FACEBOOK: MANAHIL RAJPOOT  |
        +=========================================+
        |..........  FAST FB CLONING .........|
        +-----------------------------------------+
...
""")
CorrectUsername = "MANAHIL"
CorrectPassword = "MOHEES"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/sammiykay')
    else:
...
def login():
    ...
    time.sleep(0.05)
    print "\033[1;95m[2]\x1b[1;96mClick"
    time.sleep(0.05)
...
def action():
    ...
    if peak =='':
        ...
        print '\033[1;92mEnter any code 1 to 49'
        for i in numm:
            print('x' * i)
        try:
...
\033[1;95mFb\033[1;97mCyber Knight"""
